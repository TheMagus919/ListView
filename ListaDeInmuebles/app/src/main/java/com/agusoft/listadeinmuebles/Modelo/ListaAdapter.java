package com.agusoft.listadeinmuebles.Modelo;
...
import com.agusoft.listadeinmuebles.R;
...
public class ListaAdapter extends ArrayAdapter<Inmueble> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView imagen = itemView.findViewById(R.id.foto);
        imagen.setImageResource(inmueble.getFoto());
        TextView direccion = itemView.findViewById(R.id.txDireccion);
        direccion.setText(inmueble.getDireccion());
        TextView precio = itemView.findViewById(R.id.txPrecio);
